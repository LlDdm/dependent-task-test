...
public class AppProperty {
    ...
    public AppProperty(double _startTime, int _mobileDeviceId, int _taskType, int _pesNumber, long _length, long _inputFileSize, long _outputFileSize) {
    ...
    public AppProperty(int _mobileDeviceId, int _taskType, double _startTime, ExponentialDistribution[][] expRngList) {
        mobileDeviceId=_mobileDeviceId;
        startTime=_startTime;
        taskType=_taskType;
    ...
    public AppProperty(int mobileDeviceId, double startTime, ExponentialDistribution[] expRngList) {
