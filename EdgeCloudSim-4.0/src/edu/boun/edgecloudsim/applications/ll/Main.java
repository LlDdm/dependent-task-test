...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 5){
            ...
            configFile = "scripts/ll/config/default_config.properties";
            applicationsFile = "scripts/ll/config/applications.xml";
            edgeDevicesFile = "scripts/ll/config/edge_devices.xml";
