...
public class LMobilityModel extends MobilityModel {
    private List<TreeMap<Double, Location>> treeMapArray;

    public LMobilityModel(int _numberOfMobileDevices, double _simulationTime) {
    ...
    public void initialize() {
        ...
        //initialize tree maps and position of mobile devices,将移动设备随机放置到不同的边缘设备覆盖区域
