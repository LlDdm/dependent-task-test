...
public class LMobileDeviceManager extends MobileDeviceManager {
    ...
    public LMobileDeviceManager() throws Exception{
    }
    ...
    protected void processOtherEvent(SimEvent ev) {
        ...
        switch (ev.getTag()) {
            ...
            {
                ((LNetworkModel)networkModel).updateMM1QueeuModel();
