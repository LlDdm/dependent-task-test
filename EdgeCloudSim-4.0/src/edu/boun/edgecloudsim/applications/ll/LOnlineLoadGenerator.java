...
public class LOnlineLoadGenerator extends LoadGeneratorModel{
    int taskTypeOfDevices[];

    public LOnlineLoadGenerator(int _numberOfMobileDevices, double _simulationTime, String _simScenario) {
